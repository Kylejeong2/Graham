...
// import { User, MessageSquare, Volume2, X, Phone, FileText } from 'lucide-react';
...
// export const AgentEditing: React.FC<{ agent: AgentType; user: UserType }> = ({ agent, user }) => {
...
//             const response = await fetch(`/api/agent/editAgent/${agent.id}`, {
//                 method: 'PATCH',
//                 headers: {
...
//                 //TODO: Delete TWIlIO phone number
